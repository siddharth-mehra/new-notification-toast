...
// Button component
const Button = ({ children, className = "", ...props }: PropsType) => {
  return (
    <motion.button
      className={`group relative inline-flex h-11 cursor-pointer items-center justify-center rounded-xl border-0 
